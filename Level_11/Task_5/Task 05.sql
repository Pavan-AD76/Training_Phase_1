...
WITH october_sales AS (
    SELECT sale_date, amount FROM sales WHERE sale_date BETWEEN '2023-10-01' AND '2023-10-31'
)
SELECT sale_date, amount, SUM(amount) OVER (ORDER BY sale_date) AS running_total FROM october_sales;
