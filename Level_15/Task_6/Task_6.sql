...
SELECT DISTINCT shopping_mall FROM shopping_data;

INSERT INTO payment_methods (payment_method)
SELECT DISTINCT payment_method FROM shopping_data;

INSERT INTO categories (category_name)
SELECT DISTINCT category FROM shopping_data;

INSERT INTO customers (customer_id, gender, age)
SELECT DISTINCT customer_id, gender, age FROM shopping_data;
